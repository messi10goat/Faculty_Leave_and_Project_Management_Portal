...
<html lang="en">
<head>
    <title><?php echo $v1; ?> Delete Course</title>
...
$updateResult = $col_c->deleteOne(
    [ 'fid' => $v2+0 , 'c' => $_GET['cid'], 'year' => $_GET['yearr'] ]
    
);

if(1>0)
    {
        header("location:editprofile.php?course_delete=success"); // redirects to all records page
        exit;
    }
