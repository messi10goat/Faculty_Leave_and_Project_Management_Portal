...
<html lang="en">
<head>
    <title><?php echo $v1; ?> Update Email</title>
...
<h3>Update Email</h3>
<form method="POST">
  <input class="w3-input" type="text" name="fullname" placeholder="Enter Email" Required>
  <br>
...
if(1>0)
    {
        header("location:editprofile.php?update_email=success"); // redirects to all records page
        exit;
    }
